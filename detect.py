...
def detect(original_image, min_score, max_overlap, top_k, suppress=None):
    ...
    font = ImageFont.truetype("fonts/Calibri Regular.ttf", 15)
    ...
    for i in range(det_boxes.size(0)):
        ...
        draw.rectangle(
            xy=[l + 2.0 for l in box_location], outline=label_color_map[det_labels[i]]
        )  # a third rectangle at an offset of 1 pixel to increase line thickness
        draw.rectangle(
            xy=[l + 3.0 for l in box_location], outline=label_color_map[det_labels[i]]
        )  # a fourth rectangle at an offset of 1 pixel to increase line thickness
